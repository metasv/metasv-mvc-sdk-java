...
public class TxApiTest {
     ...
     */
    @Test
    public void txBroadcastPostTest()  {
        TxRaw txRaw = null;
        BroadcastResult response = api.txBroadcastPost(txRaw).block();
     ...
     */
    @Test
    public void txTxidGetTest()  {
        String txid = null;
        Boolean showScript = null;
        TxDetail response = api.txTxidGet(txid, showScript).block();
     ...
     */
    @Test
    public void txTxidRawGetTest()  {
        String txid = null;
        TxRaw response = api.txTxidRawGet(txid).block();
     ...
     */
    @Test
    public void txTxidSeenGetTest()  {
        String txid = null;
        Boolean response = api.txTxidSeenGet(txid).block();
     ...
     */
    @Test
    public void vinTxidDetailGetTest()  {
        String txid = null;
        List<OutputInfoDetail> response = api.vinTxidDetailGet(txid).collectList().block();
