...
public class AddressApi {
    ...
    /**
     * Build call for addressAddressTxGet
     * @param address the requested address (required)
     * @param flag The last id of the last query(Paging flag) (optional)
     * @param confirmed (default true) fetch confirmed tx, fetch unconfirmed tx if false (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Get address transaction history success. </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call addressAddressTxGetCall(String address, String flag, Boolean confirmed, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/address/{address}/tx"
            .replaceAll("\\{" + "address" + "\\}", localVarApiClient.escapeString(address.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call addressAddressTxGetValidateBeforeCall(String address, String flag, Boolean confirmed, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'address' is set
        if (address == null) {
            throw new ApiException("Missing the required parameter 'address' when calling addressAddressTxGet(Async)");
        }
        

        okhttp3.Call localVarCall = addressAddressTxGetCall(address, flag, confirmed, _callback);
        return localVarCall;
     ...
     */
    public List<AddressTx> addressAddressTxGet(String address, String flag, Boolean confirmed) throws ApiException {
        ApiResponse<List<AddressTx>> localVarResp = addressAddressTxGetWithHttpInfo(address, flag, confirmed);
        return localVarResp.getData();
    }
     ...
     * @param flag The last id of the last query(Paging flag) (optional)
     * @param confirmed (default true) fetch confirmed tx, fetch unconfirmed tx if false (optional)
     * @return ApiResponse&lt;List&lt;AddressTx&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<AddressTx>> addressAddressTxGetWithHttpInfo(String address, String flag, Boolean confirmed) throws ApiException {
        okhttp3.Call localVarCall = addressAddressTxGetValidateBeforeCall(address, flag, confirmed, null);
        Type localVarReturnType = new TypeToken<List<AddressTx>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Get address history by specific address(recent 10 days available). (asynchronously)
     * 
     * @param address the requested address (required)
     * @param flag The last id of the last query(Paging flag) (optional)
     * @param confirmed (default true) fetch confirmed tx, fetch unconfirmed tx if false (optional)
     ...
     */
    public okhttp3.Call addressAddressTxGetAsync(String address, String flag, Boolean confirmed, final ApiCallback<List<AddressTx>> _callback) throws ApiException {

        okhttp3.Call localVarCall = addressAddressTxGetValidateBeforeCall(address, flag, confirmed, _callback);
        Type localVarReturnType = new TypeToken<List<AddressTx>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
