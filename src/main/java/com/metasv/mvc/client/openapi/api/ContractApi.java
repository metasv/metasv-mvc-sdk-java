...
public class ContractApi {
    ...
    /**
     * Build call for contractFtAddressAddressCodeHashGenesisTxGet
     * @param address the requested address (required)
     * @param codeHash Filter by contract code hash (required)
     * @param genesis Filter by contract genesis (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Get contract ft history success. </td><td>  -  </td></tr>
        <tr><td> 401 </td><td> Access token is missing or invalid </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call contractFtAddressAddressCodeHashGenesisTxGetCall(String address, String codeHash, String genesis, String flag, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/contract/ft/address/{address}/{codeHash}/{genesis}/tx"
            .replaceAll("\\{" + "address" + "\\}", localVarApiClient.escapeString(address.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call contractFtAddressAddressCodeHashGenesisTxGetValidateBeforeCall(String address, String codeHash, String genesis, String flag, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'address' is set
        if (address == null) {
            throw new ApiException("Missing the required parameter 'address' when calling contractFtAddressAddressCodeHashGenesisTxGet(Async)");
        }
        
        // verify the required parameter 'codeHash' is set
        if (codeHash == null) {
            throw new ApiException("Missing the required parameter 'codeHash' when calling contractFtAddressAddressCodeHashGenesisTxGet(Async)");
        }
        
        // verify the required parameter 'genesis' is set
        if (genesis == null) {
            throw new ApiException("Missing the required parameter 'genesis' when calling contractFtAddressAddressCodeHashGenesisTxGet(Async)");
        }
        

        okhttp3.Call localVarCall = contractFtAddressAddressCodeHashGenesisTxGetCall(address, codeHash, genesis, flag, _callback);
        return localVarCall;
     ...
     */
    public List<ContractFtAddressTx> contractFtAddressAddressCodeHashGenesisTxGet(String address, String codeHash, String genesis, String flag) throws ApiException {
        ApiResponse<List<ContractFtAddressTx>> localVarResp = contractFtAddressAddressCodeHashGenesisTxGetWithHttpInfo(address, codeHash, genesis, flag);
        return localVarResp.getData();
    }
     ...
     * @param genesis Filter by contract genesis (required)
     * @param flag The last id of the last query(Paging flag) (optional)
     * @return ApiResponse&lt;List&lt;ContractFtAddressTx&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<ContractFtAddressTx>> contractFtAddressAddressCodeHashGenesisTxGetWithHttpInfo(String address, String codeHash, String genesis, String flag) throws ApiException {
        okhttp3.Call localVarCall = contractFtAddressAddressCodeHashGenesisTxGetValidateBeforeCall(address, codeHash, genesis, flag, null);
        Type localVarReturnType = new TypeToken<List<ContractFtAddressTx>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call contractFtAddressAddressCodeHashGenesisTxGetAsync(String address, String codeHash, String genesis, String flag, final ApiCallback<List<ContractFtAddressTx>> _callback) throws ApiException {

        okhttp3.Call localVarCall = contractFtAddressAddressCodeHashGenesisTxGetValidateBeforeCall(address, codeHash, genesis, flag, _callback);
        Type localVarReturnType = new TypeToken<List<ContractFtAddressTx>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
