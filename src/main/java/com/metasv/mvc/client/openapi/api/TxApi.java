...
public class TxApi {
    ...
    /**
     * Build call for txBroadcastBatchPost
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> Broadcast result list, txid returned with the original order </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call txBroadcastBatchPostCall(List<TxRaw> txRaw, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = txRaw;

        // create path and map variables
        String localVarPath = "/tx/broadcast/batch";
    ...
    private okhttp3.Call txBroadcastBatchPostValidateBeforeCall(List<TxRaw> txRaw, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = txBroadcastBatchPostCall(txRaw, _callback);
        return localVarCall;
     ...
     */
    public List<BroadcastResult> txBroadcastBatchPost(List<TxRaw> txRaw) throws ApiException {
        ApiResponse<List<BroadcastResult>> localVarResp = txBroadcastBatchPostWithHttpInfo(txRaw);
     ...
     * This api will broadcast to metasv fullnode directly.
     * @param txRaw  (optional)
     * @return ApiResponse&lt;List&lt;BroadcastResult&gt;&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<List<BroadcastResult>> txBroadcastBatchPostWithHttpInfo(List<TxRaw> txRaw) throws ApiException {
        okhttp3.Call localVarCall = txBroadcastBatchPostValidateBeforeCall(txRaw, null);
        Type localVarReturnType = new TypeToken<List<BroadcastResult>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Broadcast a batch of tx to metasv fullnode. The tx will be processed one by one. (asynchronously)
     * This api will broadcast to metasv fullnode directly.
     * @param txRaw  (optional)
     ...
     */
    public okhttp3.Call txBroadcastBatchPostAsync(List<TxRaw> txRaw, final ApiCallback<List<BroadcastResult>> _callback) throws ApiException {

        okhttp3.Call localVarCall = txBroadcastBatchPostValidateBeforeCall(txRaw, _callback);
        Type localVarReturnType = new TypeToken<List<BroadcastResult>>(){}.getType();
